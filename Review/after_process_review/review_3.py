...
app = Flask(__name__)
ANNO_FOLDER = '/data3/srip_face/diving/code/Label_review/result_3/'
...
#    idx_ = test_.index(video
    return render_template('tool2.html', vid_url=VID_HTTP_BASE+video_id+'.mp4', data=anno[idx][1], data_=anno2[idx])
